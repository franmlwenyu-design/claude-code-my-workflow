...
**Focus.** China's top general-interest economics journal (CSSCI / top-2 in Chinese econ). Publishes macro and micro empirical work with Chinese data, Chinese institutional analysis, policy-oriented theory, and methodological papers when directly relevant to China. Strongly values papers that speak to Chinese governance, Chinese fiscal/monetary/social policy, and China's structural transformation. Papers must be in Chinese; data must be China-sourced or have explicit China relevance.

**Bar.** Dual requirement: (1) credible identification that survives a competent econometrician's scrutiny *within the Chinese institutional context* (IV, DiD, RDD accepted; pure OLS with controls is insufficient for a causal claim), and (2) clear, specific policy implication for Chinese government—vague "should pay attention" conclusions are insufficient. Acceptance rate ≈5–8%. Paper should reference the main domestic literature (经济研究, 经济学季刊, 管理世界, 财经研究, etc.) and situate the contribution relative to landmark domestic studies.

**Domain-referee adjustments.**
- Contribution 30 → 28 (weighted slightly toward policy fit over pure novelty)
- External validity 15 → 10 (generalizability beyond China is not required; internal validity within China is)
- Fit 10 → 20 (China relevance and domestic literature engagement are load-bearing)
- Substance 20 → 22 (economic narrative for Chinese institutional context matters)

**Methods-referee adjustments.**
- Identification 35 → 35 (unchanged; China-context IV/DiD validity is scrutinized carefully)
- Measurement 20 → 25 (Chinese data quality, official statistics biases, and definitional consistency with domestic studies are common concerns)
- Replication 5 → 5 (data availability less formalized than AEA, but code availability is increasingly expected)

**Typical concerns.**
- "内生性问题是否得到充分处理？工具变量的相关性与外生性论证是否在中国制度背景下站得住脚？"
- "数据来源和统计口径是否可靠？与主流国内文献的数据口径是否一致或有明确说明？"
- "对中国制度背景（如分税制、户籍制度、地方官员激励、债务管理改革等）的刻画是否准确、深入，是否能为识别策略提供制度支撑？"
- "政策含义是否具体、可操作，能否对当前政策实践提供直接的参考依据？"
- "与陈小亮、朱德云等国内相关研究的边际贡献和方法论差异是否清晰界定？"
...
**Table format override.** Chinese academic standard: significance stars (*/**/***)  retained; t-values in parentheses (not SE); tables numbered with Arabic numerals; all variable names should have Chinese labels in notes; figures must have Chinese axis labels and captions.

**Journal-specific priors (seed for referees).**
- R1 (POLICY disposition): Will ask whether the policy implication goes beyond "政府应重视" — needs a specific institutional lever. Will check whether the reform year (2015 debt regulation) is properly contextualized against 43号文, 新预算法, and 债务置换. Will ask about heterogeneity by fiscal autonomy tier (东部 vs 中西部).
- R2 (MEASUREMENT disposition): Will question whether 有息债务 is the right proxy for 地方政府债务 versus 显性债务 only. Will ask about data consistency with 全国债务审计 results. Will check whether sample exclusion of 新疆/西藏 is discussed. Will probe whether 老龄化率 using 常住人口 is appropriate given inter-provincial migration patterns and whether 户籍人口 老龄化 would give different results.
